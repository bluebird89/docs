...
* 了解有价值的产品/服务将如何交付以及团队需要如何支持的初步计划
- 以两周为周期生成 Sprint
- 为什么需要发布计划?
...
* 团队在一起快速地开一个会(通常在物理墙前)，成员逐个更新自己的状态
- 更新包含以下几个方面
    + 昨天完成的工作
    + 今天计划做的工作
    + 面临什么阻碍，需要什么帮助
...
* 通常发生在每个迭代的最后一天，目的是演示可工作的软件。团队把一个迭代中开发好的功能给相关人员演示，并收集反馈，以便在下一个迭代中可以对变化作出快速响应
...
+ Dev
	...
	*  Dev 在从 Ready for Dev 栏领取 Story 时，流程
		...
		- 找 BA 和 QA kick off
		- 确定 AC
	- Desk Check:开发完把卡片挪到 Ready for QA 前，需把 QA 叫到自己的电脑上，使用测试环境，根据 AC 演示功能
...
* 精益。源自丰田生产方式的“精益”的愿景就是“Shortest lead time”，即用最短的时间来完成从客户下订单到收到货物的全过程
	* 2021年第2季度，丰田汽车在美国的销量达到68.8万辆，比通用汽车销量高出577辆。这是丰田在美国本土销量首次超过通用。这主要得益于其他车厂苦于缺少零部件和芯片时，教会全世界“准时生产方式”和“零库存”的丰田，自己却提前备足库存。
...
* [质疑或困惑](https://mp.weixin.qq.com/s/5MP7scRLcB0oXOOjPVpzww)
...
* a visual way to manage Agile work.
...
* 不会划分优先级：如果认为所有任务都很重要，也就意味着所有任务都不重要
  - 每次仅完成一件事，并将其做到最好
* 眼高手低：缺少的不是用简笔画画出几个圆圈，而正是那些被轻视的细节。用相同的方法和原则把复杂的业务逻辑抽象并归类.技巧：
  - Code kata
  - 用脚本来自动化一些常见任务
  - 重构复杂的业务代码
  - 通过刻意训练保持动手能力
...
* 团队成员不熟悉
  - 基于敏捷实践，创造更多的沟通机会，比如回顾会议、代码审查和站立会议。
  - 通过不断地创造这样的沟通机会让团队成员更加默契
* 信息发布不顺畅
  - 共享信息，制定沟通计划
  - 最大程度的可视化
...
* 《深入核心的敏捷开发》
* 敏捷软件开发——原则、模式与实践
* 《持续交付 发布可靠软件的系统方法 Continuous Delivery》Jez Humble
