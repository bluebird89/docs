...
* 框架组件 Components 来自web开发框架的独立组件
      ...
      - (https://hoa-project.net/En/)[Hoa Project]: 另一个PHP组件包
      - (https://thephpleague.com/)[League of Extraordinary Packages]: 一个PHP软件开发组
      - (http://symfony.com/doc/master/components/index.html)[Symfony Components]: Symfony组件
      - (https://packages.zendframework.com/)[Zend Framework 2 Components]: Zend Framework 2组件
* 微型框架 Micro Frameworks 微型框架和路由
      - (http://bulletphp.com/)[Bullet PHP]: 用于构建REST APIs的微型框架
      - (https://lumen.laravel.com)[Lumen]: 一个Laravel的微型框架
      - (https://github.com/alexbilbie/Proton)[Proton]: 一个StackPHP兼容的微型框架
      - (http://silex.sensiolabs.org/)[Silex]: 基于Symfony2组件的微型框架
      - (https://www.slimframework.com/)[Slim]: 另一个简单的微型框架
* 其他微型框架 Micro Framework Extras 其他相关的微型框架和路由
      - (https://github.com/silexphp/Silex-Skeleton)[Silex Skeleton]: Silex的项目架构
      - (https://github.com/silexphp/Silex-WebProfiler)[Silex Web Profiler]: 一个Silex web的调试工具
      - (https://github.com/slimphp/Slim-Skeleton)[Slim Skeleton]: Slim架构
      - (https://github.com/slimphp/Slim-Views)[Slim View]: Slim自定义视图的集合
* 路由 Routers 处理应用路由的库
      - (https://github.com/nikic/FastRoute)[Fast Route]: 一个快速路由的库
      - (https://github.com/klein/klein.php)[Klein]: 一个灵活的路由的库
      - (https://github.com/c9s/Pux)[Pux]: 另一个快速路由的库
      - (https://github.com/thephpleague/route)[Route]: 一个基于Fast Route的路由的库
* 模板 Templating 模板化和词法分析的库和工具
      - (https://github.com/FoilPHP/Foil)[Foil]: 另一个原生PHP模板库
      - (https://github.com/pyrocms/lex)[Lex]: 一个轻量级模板解析器
      - (https://github.com/arnaud-lb/MtHaml)[MtHaml]: 一个HAML模板语言的PHP实现
      - (https://github.com/bobthecow/mustache.php)[Mustache]: 一个Mustache模板语言的PHP实现
      - (https://github.com/phly/phly_mustache)[Phly Mustache]: 另一个Mustache模板语言的PHP实现
      - (http://phptal.org/)[PHPTAL]: 一个模板语言的PHP实现
      - (http://platesphp.com/)[Plates]: 一个原生PHP模板库
      - (http://www.smarty.net/)[Smarty]: 一个模板引擎
      - (http://twig.sensiolabs.org/)[Twig]: 一个全面的模板语言
      - (https://github.com/Talesoft/tale-jade)[Tale Jade]: Jade模版语言的PHP实现
* 静态站点生成器 Static Site Generators 用来生成web页面的预处理内容的工具
      - (http://couscous.io)[Couscous]: 一个将Markdown转化为漂亮的网站的工具
      - (https://github.com/Pawka/phrozn)[Phrozn]: 另一个转换Textile，Markdown和Twig为HTML的工具
      - (https://sculpin.io)[Sculpin]: 转换Markdown和Twig为静态HTML的工具
      - (http://spress.yosymfony.com)[Spress]: 一个能够将Markdown和Twig转化为HTML的可扩展工具
...
* 流 Streams 处理流的库
      - (https://github.com/fzaninotto/Streamer)[Streamer]: 一个简单的面向对象的流包装库
...
* 日志 Logging 生成和处理日志文件的库
      - (https://github.com/jbroadway/analog)[Analog]: 一个基于闭包的微型日志包
      - (https://github.com/katzgrau/KLogger)[KLogger]: 一个易用的兼容PSR-3的日志类
      - (https://github.com/Seldaek/monolog)[Monolog]: 一个全面的日志工具
* 电子商务 E-commerce 处理支付和构建在线电子商务商店的库和应用
      - (https://github.com/moneyphp/money)[Money]: 一个Fowler金钱模式的PHP实现
      - (https://github.com/thephpleague/omnipay)[OmniPay]: 一个框架混合了多网关支付处理的库
      - (https://github.com/payum/payum)[Payum]: 一个支付抽象库
      - (https://github.com/shopware/shopware)[Shopware]: 一个可高度定制的电子商务软件
      - (https://github.com/florianv/swap)[Swap]: 一个汇率库
      - (http://sylius.org/)[Sylius]: 一个开源的电子商务解决方案
* PDF 处理PDF文件的库和软件
...
* 国际化和本地化 Internationalisation and Localisation 国际化(I18n)和本地化(L10n)的库
      - (https://github.com/cakephp/i18n)[Cake I18n]: 消息国际化和日期和数字的本地化 (CP)
...
* 扩展 Extensions 帮助构建PHP扩展的库
      - (http://www.php-cpp.com/)[PHP CPP]: 一个开发PHP扩展的C++库
      - (https://github.com/phalcon/zephir)[Zephir]: 用于开发PHP扩展，且介于PHP和C++之间的编译语言
...
* 基础架构 Infrastructure 提供PHP应用和服务的基础架构
      - (http://appserver.io/)[appserver.io]: 一个用PHP写的多线程的PHP应用服务器
      - (https://github.com/php-pm/php-pm)[php-pm]: 一个PHP应用的进程管理器、修改器和负载平衡器
...
* PHP视频 PHP Videos PHP相关的非常不错的视频
      - (https://www.youtube.com/c/nomadphp)[Nomad PHP Lightning Talks]: PHP社区成员10到15分钟的快速会谈
      - (https://www.youtube.com/user/phpukconference/videos)[PHP UK Conference]: 一个PHP英国会议的视频集合
      - (https://www.youtube.com/playlist?list=PLM-218uGSX3DQ3KsB5NJnuOqPqc5CW2kW)[Programming with Anthony]: Anthony Ferrara的视频系列
      - (https://www.infoq.com/presentations/php-history)[Taking PHP Seriously]: 来自Facebook Keith Adams 讲述PHP优势
* PHP播客 PHP Podcasts 专注于PHP话题的博客
      - (https://phptownhall.com/)[PHP Town Hall]: 一个随意的Ben Edmunds和Phil Sturgeon的PHP播客
      - (https://www.phproundtable.com/)[PHP Roundtable]: PHP Roundtable是一个讨论PHP开发者关心话题的临时聚会
* PHP阅读 PHP Reading PHP相关的阅读资料
      - (https://daylerees.com/composer-primer/)[Composer Primer]: Composer初级使用
      - (https://igor.io/2013/02/07/composer-stability-flags.html)[Composer Stability Flags]: 一篇关于Composer稳定性标志的文章
      - (https://igor.io/2013/01/07/composer-versioning.html)[Composer Versioning]: 一篇关于Composer版本的文章
      - (http://fabien.potencier.org/create-your-own-framework-on-top-of-the-symfony2-components-part-1.html)[Create Your Own PHP Framework]: 一部Fabien Potencier的关于如何创建你自己的PHP框架的系列文章
      - (http://blog.ircmaxell.com/2013/08/dont-worry-about-breach.html)[Don't Worry About BREACH]: 一篇关于BREACH攻击和CSRF令牌的文章
      - (http://fabien.potencier.org/on-php-5-3-lambda-functions-and-closures.html)[On PHP 5.3, Lambda Functions and Closures]: 一篇关于lambda函数和闭包的文章
      - (http://fabien.potencier.org/php-is-much-better-than-you-think.html)[PHP Is Much Better Than You Think]: 一篇关于PHP语言和生态圈的文章
      - (http://phppackagechecklist.com/)[PHP Package Checklist]: 一个成功PHP包开发的清单
      - (http://blog.ircmaxell.com/2012/04/php-sucks-but-i-like-it.html)[PHP Sucks! But I Like It!]: 一篇关于PHP利弊的文章
      - (http://blog.ircmaxell.com/2013/02/preventing-csrf-attacks.html)[Preventing CSRF Attacks]: 一篇阻止CSRF攻击的文章
      - (http://blog.ircmaxell.com/2012/12/seven-ways-to-screw-up-bcrypt.html)[Seven Ways to Screw Up BCrypt]: 一篇关于纠正BCrypt实现的文章
      - (https://seancoates.com/blogs/use-env/)[Use Env]: 一篇关于使用unix环境帮助的文章
* PHP内核阅读 PHP Internals Reading 阅读PHP内核或性能相关的资料
      - (http://nikic.github.io/2012/01/09/Disproving-the-Single-Quotes-Performance-Myth.html)[Disproving the Single Quotes Myth]: 一篇关于单，双引号字符串性能的文章
      - (http://nikic.github.io/2011/12/12/How-big-are-PHP-arrays-really-Hint-BIG.html)[How Big Are PHP Arrays (And Values) Really?]: 一篇关于数组原理的文章
      - (http://stackoverflow.com/questions/10057671/how-does-php-foreach-actually-work/14854568#14854568)[How Foreach Works]: StackOverflow关于foreach回答的详情
      - (http://blog.golemon.com/2006/06/how-long-is-piece-of-string.html)[How Long is a Piece of String]: 一篇关于字符串原理的文章
      - (https://gist.github.com/nikic/6699370)[PHP Evaluation Order]: 一篇关于PHP评估顺序的文章
      - (http://www.phpinternalsbook.com)[PHP Internals Book]: 一本由三名核心开发编写的关于PHP内核的在线书
      - (https://wiki.php.net/rfc)[PHP RFCs]: PHP RFCs主页(请求注解)
      - (http://fabien.potencier.org/print-vs-echo-which-one-is-faster.html)[Print vs Echo, Which One is Faster?]: 一篇关于打印和echo性能的文章
      - (http://fabien.potencier.org/the-php-ternary-operator-fast-or-not.html)[The PHP Ternary Operator. Fast or Not?]: 一篇关于三元操作性能的文章
      - (http://blog.golemon.com/2008/01/understanding-opcodes.html)[Understanding OpCodes]: 一篇关于opcodes的文章
      - (http://nikic.github.io/2011/11/11/PHP-Internals-When-does-foreach-copy.html)[When Does Foreach Copy?]: 一篇关于foreach原理的文章
      - (https://gist.github.com/nikic/5015323)[Why Objects (Usually) Use Less Memory Than Arrays]: 一篇关于对象和数组原理的文章
      - (http://blog.golemon.com/2007/01/youre-being-lied-to.html)[You're Being Lied To]: 一篇关于内核ZVALs的文章

## 参考

* [Awesome PHP](http://coffeephp.com/resources#%E8%B4%A1%E7%8C%AE)
