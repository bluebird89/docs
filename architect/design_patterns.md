---
date updated: '2021-07-14T12:35:32+08:00'
...
- 不需要自己内容修改，改成由外部传递。由外部负责其依赖需求的行为
- “控制”指的是对程序执行流程的控制
...
- [《设计模式解析 Design Patterns Explained》](https://portal.netobjectives.com/pages/books/design-patterns-explained/)
- 《设计模式之禅》
- 《深入浅出设计模式》
